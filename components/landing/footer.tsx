...
const footerLinks = {
  produto: [
    ...
    { label: "Integração WhatsApp", href: "#" },
...
export function Footer() {
  return (
    <footer className="bg-[#0A2540] py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm text-white/60">
              Sistema completo de gestão para dentistas. Sua clínica no piloto automático.
            </p>
            <p className="mt-6 text-sm text-white/40">
              Feito para dentistas brasileiros
            </p>
          </div>
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 lg:flex-row">
          <p className="text-sm text-white/40">
            © 2024 DentistOS. Todos os direitos reservados.
          </p>
